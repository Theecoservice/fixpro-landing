...
const faqs = [
  ...
  },
  {
    ...
    a: "Кожен номер клієнта проходить верифікацію перед відправкою заявки. Ми передаємо лише реальні контакти — подальша комунікація з клієнтом залежить від вас.",
  },
  {
